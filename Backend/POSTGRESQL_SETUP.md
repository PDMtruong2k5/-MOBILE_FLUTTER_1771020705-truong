...
Database: `pcm705database` với các bảng:

**Custom tables** (prefix 705):
- `705_Members`
- `705_WalletTransactions`
- `705_Courts`
- `705_Bookings`
- `705_Tournaments`
- `705_TournamentParticipants`
- `705_Matches`
- `705_News`
- `705_Notifications`
...
```bash
psql -U postgres -d pcm705database

# Xem các bảng
\dt

# Xem data
SELECT * FROM "705_Members";
