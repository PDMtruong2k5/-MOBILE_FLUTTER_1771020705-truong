...
namespace PcmBackend.Data
{
    ...
    {
        private const string TABLE_PREFIX = "705_";
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            // Explicit table naming with student MSSV prefix
            builder.Entity<Member>().ToTable(TABLE_PREFIX + "Members");
            builder.Entity<WalletTransaction>().ToTable(TABLE_PREFIX + "WalletTransactions");
            builder.Entity<Court>().ToTable(TABLE_PREFIX + "Courts");
            builder.Entity<Booking>().ToTable(TABLE_PREFIX + "Bookings");
            builder.Entity<Tournament>().ToTable(TABLE_PREFIX + "Tournaments");
            builder.Entity<TournamentParticipant>().ToTable(TABLE_PREFIX + "TournamentParticipants");
            builder.Entity<Match>().ToTable(TABLE_PREFIX + "Matches");
            builder.Entity<News>().ToTable(TABLE_PREFIX + "News");
            builder.Entity<Notification>().ToTable(TABLE_PREFIX + "Notifications");
            builder.Entity<TransactionCategory>().ToTable(TABLE_PREFIX + "TransactionCategories");
        }
    }
}
